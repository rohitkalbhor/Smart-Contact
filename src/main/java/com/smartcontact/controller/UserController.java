...
public class UserController {
	...
	public String processContact(@ModelAttribute Contact contact, @RequestParam("profileImage") MultipartFile file,
		...
		try {
			...
			if (file.isEmpty()) {
				...
				// file the file to folder and update the name to connect
	...
	public String update(@ModelAttribute Contact contact, @RequestParam("profileImage") MultipartFile file, Model m,
		...
		try {
			...
			Message message = new Message("Your contact is updated....", "success");
